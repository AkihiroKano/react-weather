...
import { CloseIcon, HistoryIcon, Trash2 } from '../common/Icons.jsx'
...
const HistoryDrawer = ({ isOpen, onClose, onSelect }) => {
    ...
    return (
        <>
            ...
            <div
                ref={drawerRef}
                className={`fixed top-0 right-0 h-full w-80 max-w-[90vw] bg-white dark:bg-gray-900 shadow-xl z-50 transform transition-transform ${isOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
                    ...
                    {history.length > 0 ? (
                        <>
                            ...
                            <button
                                ...
                                className="w-full mt-4 py-2 text-sm text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 transition-colors flex items-center justify-center gap-2"
                            >
